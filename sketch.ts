...
class Node {
	...
	run : number;
  	...
  	constructor(xpos_ : number, ypos_ : number, speed_ : number, rise_ : number, run_ : number) {
		this.xpos = xpos_;
		this.ypos = ypos_;
		this.speed = speed_;
		this.run = run_;
